...
<section>
    ...
    <x-error-message name="description"/>
        ...
        <div class="form-group">
            <div class="form-row">
                <div class="col"><label class="custom-file-label" for="featured_img">Imagen de cabecera<br></label><input class="custom-file-input @error('featured_img') is-invalid @enderror" id="featured_img" name="featured_img" type="file">
